...
Ask 1 questions about the content and generate four options for each question. 
The questions should be answerable with the information provided in the caption, 
and the four options should include one correct and three incorrect options, 
with the position of the correct option randomized. 
...
def build_prompt_from_row(row: Dict[str, Any]) -> str:
    ...
    return RUBRIC_PROMPT_TEMPLATE.replace("{CAPTION_BLOCK}", cap_block)

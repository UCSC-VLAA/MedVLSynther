...
# —— 把 parquet 拷到本地盘（若源数据更新请重拷） ——
rsync -a /home/efs/nwang60/datasets/biomedica_webdataset_glm_generated_qwen_verified_VQA_parquet_25k_filtered_13k_subset10k_verl/train.parquet /tmp/trainset/
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name='qwen2_5_vl_7b_biomedica_webdataset_glm_generated_qwen_verified_VQA_parquet_25k_filtered_13k_subset10k_v3' \

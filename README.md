...
|---|---|---|---|---|---|
| **MedVLSynther-13K** | GLM-4.5V 108B | Qwen2.5-VL 72B | Image–Text | Full training set for medical VQA (used for RLVR). | [🤗 HF]() |
| **MedVLSynther-10K** | GLM-4.5V 108B | Qwen2.5-VL 72B | Image–Text | 10K-sample training subset for RLVR. | [🤗 HF]() |
| **MedVLSynther-5K**  | GLM-4.5V 108B | Qwen2.5-VL 72B | Image–Text | 5K-sample training subset for RLVR. | [🤗 HF]() |
| **MedVLSynther-2K**  | GLM-4.5V 108B | Qwen2.5-VL 72B | Image–Text | 2K-sample training subset for RLVR. | [🤗 HF]() |
| **MedVLSynther-1K**  | GLM-4.5V 108B | Qwen2.5-VL 72B | Image–Text | 1K-sample training subset for RLVR. | [🤗 HF]() |
| **MedVLSynther-5K-qwen-glm** | Qwen2.5-VL 72B | GLM-4.5V 108B | Image–Text | 5K subset for **generator and verifier choice** ablation (GLM→Qwen generator, Qwen→GLM verifier). | [🤗 HF]() |
| **MedVLSynther-5K-internvl-glm** | InternVL-3.5 38B | GLM-4.5V 108B | Image–Text | 5K subset for **generator choice** ablation (InternVL→GLM verifier). | [🤗 HF]() |
| **MedVLSynther-5K-glm-glm** | GLM-4.5V 108B | GLM-4.5V 108B | Image–Text | 5K subset for **verifier choice** ablation (Qwen→GLM verifier). | [🤗 HF]() |
| **MedVLSynther-5K-no-verify** | GLM-4.5V 108B | N/A | Image–Text | 5K subset for **verifier necessity** ablation (no verification step). | [🤗 HF]() |
| **MedVLSynther-5K-PMC-style** | GLM-4.5V 108B | N/A | Image–Text | 5K subset generated with **PMC-VQA–style** prompts. | [🤗 HF]() |
| **MedVLSynther-5K-SFT** | GLM-4.5V 108B | N/A | Image–Text | 5K subset generated for SFT training. | [🤗 HF]() |
...
|-------|------|----------------|---------------|----------|
| **RL Models** |
| MedVLSynther-3B-RL_1K | 3B | RL | MedVLSynther-1K | [🤗 HF]() |
| MedVLSynther-3B-RL_2K | 3B | RL | MedVLSynther-2K | [🤗 HF]() |
| MedVLSynther-3B-RL_5K | 3B | RL | MedVLSynther-5K | [🤗 HF]() |
| MedVLSynther-3B-RL_10K | 3B | RL | MedVLSynther-10K | [🤗 HF]() |
| MedVLSynther-3B-RL_13K | 3B | RL | MedVLSynther-13K | [🤗 HF]() |
| MedVLSynther-3B-RL_5K_qwen-glm | 3B | RL | MedVLSynther-5K-qwen-glm | [🤗 HF]() |
| MedVLSynther-3B-RL_5K_internvl-glm | 3B | RL | MedVLSynther-5K-internvl-glm | [🤗 HF]() |
| MedVLSynther-3B-RL_5K_glm-glm | 3B | RL | MedVLSynther-5K-glm-glm | [🤗 HF]() |
| MedVLSynther-3B-RL_5K_no-verify | 3B | RL | MedVLSynther-5K-no-verify | [🤗 HF]() |
| MedVLSynther-3B-RL_5K_PMC-style | 3B | RL | MedVLSynther-5K-PMC-style | [🤗 HF]() |
| MedVLSynther-7B-RL_1K | 7B | RL | MedVLSynther-1K | [🤗 HF]() |
| MedVLSynther-7B-RL_2K | 7B | RL | MedVLSynther-2K | [🤗 HF]() |
| MedVLSynther-7B-RL_5K | 7B | RL | MedVLSynther-5K | [🤗 HF]() |
| MedVLSynther-7B-RL_10K | 7B | RL | MedVLSynther-10K | [🤗 HF]() |
| MedVLSynther-7B-RL_13K | 7B | RL | MedVLSynther-13K | [🤗 HF]() |
| MedVLSynther-7B-RL_5K_qwen-glm | 7B | RL | MedVLSynther-5K-qwen-glm | [🤗 HF]() |
| MedVLSynther-7B-RL_5K_internvl-glm | 7B | RL | MedVLSynther-5K-internvl-glm | [🤗 HF]() |
| MedVLSynther-7B-RL_5K_glm-glm | 7B | RL | MedVLSynther-5K-glm-glm | [🤗 HF]() |
| MedVLSynther-7B-RL_5K_no-verify | 7B | RL | MedVLSynther-5K-no-verify | [🤗 HF]() |
| MedVLSynther-7B-RL_5K_PMC-style | 7B | RL | MedVLSynther-5K-PMC-style | [🤗 HF]() |
| **SFT Models** |
| MedVLThinker-3B-SFT_5K | 3B | SFT | MedVLSynther-5K-SFT | [🤗 HF]() |
| MedVLThinker-7B-SFT_5K | 7B | SFT | MedVLSynther-5K-SFT | [🤗 HF]() |
